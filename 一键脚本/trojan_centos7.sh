...
if [ $real_addr == $local_addr ] ; then
	...
	wget https://github.com/cywy/Linux/raw/master/一键脚本/web.zip
    	unzip web.zip
	...
	tar xf trojan-1.*
	#下载trojan客户端
	wget https://github.com/cywy/Linux/raw/master/一键脚本/trojan-cli.zip
	...
	cat > /usr/src/trojan-cli/config.json <<-EOF
{
    ...
    "ssl": {
        ...
        "cert": "fullchain.cer",
        "cipher": "TLS13-AES-256-GCM-SHA384:TLS13-CHACHA20-POLY1305-SHA256:TLS13-AES-128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-CHACHA20-POLY1305-SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-ECDSA-CHACHA20-POLY1305-SHA256:ECDHE-ECDSA-AES128-SHA256",
        "sni": "",
        "alpn": [
            "h2",
            "http/1.1"
